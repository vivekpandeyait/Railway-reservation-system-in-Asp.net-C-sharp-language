<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="mini_project.HOME" %>
 ...
 <a class="navbar-brand" href="#">
  ...
  <center>
       ...
       <asp:TextBox ID="TextBox2" runat="server" Height="30px" Width="152px"></asp:TextBox>
        ...
        <ajaxToolkit:AutoCompleteExtender ID="TextBox2_AutoCompleteExtender" runat="server" BehaviorID="TextBox1_AutoCompleteExtender" DelimiterCharacters="" ServiceMethod="SOURCEDATA" TargetControlID="TextBox2" CompletionSetCount="10" CompletionInterval="100" MinimumPrefixLength="1">
...
<div class="card" style="width:auto;float:left;">
 <a class="navbar-brand" href="#">
  ...
  <div class="card-body">
       ...
       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="trainno" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            <Columns>
                ...
                <asp:BoundField DataField="jdate" HeaderText="jdate" SortExpression="jdate" />
                  ...
                  <asp:HyperLinkField HeaderText="SLEEPER"
                       ...
                       DataNavigateUrlFormatString="user/DETAIL.aspx?trainno={0}" Text="Booking Now" /> 
